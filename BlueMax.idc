...
static Enums_0(id) {
	...
	add_enum_member(id,"UNKNOWNS_STATE_SHOOT_BOMB",	0X5,	-1);
...
static ApplyStrucTInfos_0(void) {
	...
	id = get_struc_id("DIFFICULTY_STRUCT");
...
static Structures_0(id) {
	...
	id = add_struc(-1,"DIFFICULTY_STRUCT",0);
	...
	mid = add_struc_member(id,"bomb_probability",	0X2,	0x000400,	-1,	1);
	set_member_cmt(id,	0X2,	"Probability (0-255) for a bomb to be dropped",	1);
	mid = add_struc_member(id,"field_3",	0X3,	0x000400,	-1,	1);
	mid = add_struc_member(id,"field_4",	0X4,	0x000400,	-1,	1);
	mid = add_struc_member(id,"plane_height",	0X5,	0x000400,	-1,	1);
	set_member_cmt(id,	0X5,	"Height of the plane for the player (for collision detection)",	1);
	mid = add_struc_member(id,"plane_vertical_crash_distance",	0X6,	0x000400,	-1,	1);
	set_member_cmt(id,	0X6,	"minimun vertical distance to detect a crash",	1);
	...
	mid = add_struc_member(id,"char_SPACE",	0X8,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"empty_3",	0XD,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_4",	0XE,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"empty_5",	0X13,	0x000400,	-1,	1);
	mid = add_struc_member(id,"enemy_above_warning",	0X14,	0x000400,	-1,	1);
	set_member_cmt(id,	0X14,	"red \"*\" character",	1);
	mid = add_struc_member(id,"empty_6",	0X15,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_7",	0X16,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_8",	0X17,	0x000400,	-1,	1);
	
	id = get_struc_id("CONTROL_DISPLAY_LINE_1");
	mid = add_struc_member(id,"empty_0",	0,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_1",	0X1,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_2",	0X2,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_S",	0X3,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_P",	0X4,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_D",	0X5,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_COLLON",	0X6,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"char_SPACE",	0XA,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_A",	0XB,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_L",	0XC,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_T",	0XD,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_COLLON_2",	0XE,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"char_SPACE_1",	0X12,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_SPACE_2",	0X13,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"empty_3",	0X16,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_4",	0X17,	0x000400,	-1,	1);
	...
	mid = add_struc_member(id,"empty_2",	0X2,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_S",	0X3,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_C",	0X4,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_O",	0X5,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_R",	0X6,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_E",	0X7,	0x000400,	-1,	1);
	mid = add_struc_member(id,"char_COLLON",	0X8,	0x000400,	-1,	1);
	mid = add_struc_member(id,"score_digit_10000",	0X9,	0x000400,	-1,	1);
	mid = add_struc_member(id,"score_digit_1000",	0XA,	0x000400,	-1,	1);
	mid = add_struc_member(id,"score_digit_100",	0XB,	0x000400,	-1,	1);
	mid = add_struc_member(id,"score_digit_10",	0XC,	0x000400,	-1,	1);
	mid = add_struc_member(id,"score_digit_1",	0XD,	0x000400,	-1,	1);
	set_member_cmt(id,	0XD,	"always 0",	1);
	mid = add_struc_member(id,"empty_3",	0XE,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_4",	0XF,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_5",	0X10,	0x000400,	-1,	1);
	mid = add_struc_member(id,"landing_flag",	0X11,	0x000400,	-1,	1);
	set_member_cmt(id,	0X11,	"\"L\" character",	1);
	mid = add_struc_member(id,"empty_6",	0X12,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_7",	0X13,	0x000400,	-1,	1);
	mid = add_struc_member(id,"enemy_below_warning",	0X14,	0x000400,	-1,	1);
	set_member_cmt(id,	0X14,	"red \"*\" character",	1);
	mid = add_struc_member(id,"empty_8",	0X15,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_9",	0X16,	0x000400,	-1,	1);
	mid = add_struc_member(id,"empty_10",	0X17,	0x000400,	-1,	1);
...
#define id x
	...
	create_byte	(0X655);
	create_byte	(0X656);
	set_name	(0X656,	"ENEMY_BOMB_Y_POS");
	create_byte	(0X657);
	set_name	(0X657,	"ENEMY_BOMB_X_POS");
	create_byte	(0X658);
	...
	MakeStruct	(0X6C8,	"DIFFICULTY_STRUCT");
	set_name	(0X6C8,	"DIFF");
	create_byte	(0X6CF);
	create_byte	(0X6D0);
	...
	set_cmt	(0X78B,	"DL_BLK8",	0);
	update_extra_cmt		(0X78B,	E_PREV + 0,	" ");
	create_byte	(0X78B);
	set_name	(0X78B,	"DISPLAY_LIST");
	set_cmt	(0X78C,	"DL_BLK8",	0);
	create_byte	(0X78C);
	set_cmt	(0X78D,	"DL_BLK8",	0);
	create_byte	(0X78D);
	set_cmt	(0X78E,	"DL_CHR20x16x2",	0);
	create_byte	(0X78E);
	set_cmt	(0X78F,	"<adr>",	0);
	create_word	(x=0X78F);
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X791,	"DL_BLK8",	0);
	create_byte	(0X791);
	set_cmt	(0X792,	"DL_BLK8",	0);
	create_byte	(0X792);
	set_cmt	(0X793,	"DL_BLK8",	0);
	create_byte	(0X793);
	set_cmt	(0X794,	"DL_CHR20x8x2",	0);
	create_byte	(0X794);
	set_cmt	(0X795,	"DL_JVB",	0);
	create_byte	(0X795);
	set_cmt	(0X796,	"<adr>",	0);
	create_word	(x=0X796);
	op_plain_offset	(x,	0,	0);
	...
	set_cmt	(0XC4B,	"Display List: DL_LMS + DL_HSCROL",	1);
	update_extra_cmt		(0XC4B,	E_PREV + 0,	" ");
	set_cmt	(0XC53,	"Display List: DL_CHR40x8x4 + DL_HSCROL + DL_VSCROL + DL_LMS",	1);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0XC81,	"Display List: DL_BLK1 + DL_DLI",	1);
	update_extra_cmt		(0XC81,	E_PREV + 0,	" ");
	create_insn	(x=0XC83);
	set_cmt	(0XC86,	"Display List: DL_CHR40x8x4 + DL_HSCROL + DL_LMS <adr>",	1);
	create_insn	(x=0XC88);
	set_cmt	(0XC8B,	"Display List: DL_BLK3",	1);
	create_insn	(x=0XC8D);
	set_cmt	(0XC90,	"Display List: DL_CHR20x8x2 + DL_LMS <adr>",	1);
	create_insn	(x=0XC92);
	...
	create_insn	(x=0XCA8);
	create_insn	(x=0XCAA);
	set_cmt	(0XCAD,	"Display List: DL_CHR20x8x2",	1);
	create_insn	(x=0XCAF);
	create_insn	(x=0XCB2);
	set_cmt	(0XCB5,	"Display List: DL_JVB <adr>",	1);
	create_insn	(x=0XCB7);
	create_insn	(x=0XCBA);
	create_insn	(x=0XCBC);
	create_insn	(x=0XCC2);
...
#define id x
	...
	op_dec		(x,	0);
	set_cmt	(0X4578,	"=> primary targets reached => max. difficulty",	1);
	set_cmt	(0X457A,	"=> over 9999 points => max. difficulty",	1);
	...
	op_dec		(x,	0);
	set_cmt	(0X459B,	"Difficulty for a score above 8999 points",	1);
	...
	set_cmt	(0X45A5,	"Difficulty for a score below 3000 points",	1);
	create_insn	(x=0X45A5);
	op_dec		(x,	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X45B3,	"Difficulty for a score below 4000 points",	1);
	create_insn	(x=0X45B3);
	op_dec		(x,	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X45C1,	"Difficulty for a score below 6000 points",	1);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X45CB,	"Difficulty for a score below 8000 points",	1);
	...
	create_insn	(0X4D1A);
	create_insn	(x=0X4D1D);
	op_dec		(x,	0);
	set_cmt	(0X4D2A,	"Select the ROM font",	1);
	create_insn	(x=0X4D33);
	op_dec		(x,	0);
	...
	update_extra_cmt		(0X4D72,	E_PREV + 0,	" ");
	...
	set_cmt	(0X5504,	"Base Difficulty for Novice",	1);
	update_extra_cmt		(0X5504,	E_PREV + 0,	" ");
	MakeStruct	(0X5504,	"DIFFICULTY_STRUCT");
	set_name	(0X5504,	"EAS0");
	create_byte	(0X550B);
	set_cmt	(0X550C,	"Difficulty for a score below 2000 points",	1);
	MakeStruct	(0X550C,	"DIFFICULTY_STRUCT");
	set_name	(0X550C,	"EAS2");
	set_cmt	(0X5513,	"Difficulty for a score below 4000 points",	1);
	MakeStruct	(0X5513,	"DIFFICULTY_STRUCT");
	set_name	(0X5513,	"EAS4");
	set_cmt	(0X551A,	"Difficulty for a score below 6000 points or Intermediate",	1);
	MakeStruct	(0X551A,	"DIFFICULTY_STRUCT");
	set_name	(0X551A,	"EAS6");
	set_cmt	(0X5521,	"Difficulty for a score below 8000 points",	1);
	MakeStruct	(0X5521,	"DIFFICULTY_STRUCT");
	set_name	(0X5521,	"EAS8");
	set_cmt	(0X5528,	"Difficulty for a score above 8999 points or Advanced",	1);
	MakeStruct	(0X5528,	"DIFFICULTY_STRUCT");
...
static Functions_0(void) {
	...
	set_func_cmt(0X2E42,	"Show a warning, if an enemy is approaching above/below the placer", 1);
	set_name(0X2E56, ".4", SN_LOCAL);
	set_name(0X2E57, ".1", SN_LOCAL);
	add_func    (0X2E5B,0X2E66);
	set_func_flags(0X2E5B,0x1000);
	set_func_cmt(0X2E5B,	"Remove enemy approaching warnings", 1);
	...
	set_func_cmt(0X4569,	"Check and update difficulty variables depending on the progress/score", 1);
	set_name(0X459B, ".1", SN_LOCAL);
	set_name(0X45A4, ".2", SN_LOCAL);
	set_name(0X45A5, ".3", SN_LOCAL);
	set_name(0X45B3, ".4", SN_LOCAL);
	set_name(0X45C1, ".5", SN_LOCAL);
	set_name(0X45CB, ".6", SN_LOCAL);
	...
	set_func_cmt(0X4A73,	"Play gun sound, if enabled", 1);
